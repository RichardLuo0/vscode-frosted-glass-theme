export const msg = {
  tryAdmin:
    "Require admin privileges to apply changes. Click `Try as Admin` to try with admin privileges.",
  admin: "Run VS Code with admin privileges so the changes can be applied.",
  enabled: `Frosted glass theme enabled. Restart to take effect.
If Code complains about it is corrupted, CLICK DON'T SHOW AGAIN.
See README for more detail.`,
  applied: `Changes have been applied. Restart to take effect.
